...
class PageMeta
{
    ...
    private $totalItemsCount; // total cartItems in total
    private $requestedPageSize; // max cartItems per page

    private $currentItemsCount; // cartItems in this page
    ...
    public static function build($paginator, String $basePath)
    {
        ...
        return [
            ...
            'offset' => ($paginator->perPage()) * $paginator->currentPage(),
            'requested_page_size' => $paginator->perPage(),
